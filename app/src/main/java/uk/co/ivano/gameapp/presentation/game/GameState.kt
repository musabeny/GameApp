...
data class GameState(
    ...
    val fallingObject4: FallingObject = FallingObject(0f,false, icon = R.drawable.vegetables,chance = GameChance.Life),
    val fallingObject5: FallingObject = FallingObject(0f,false, icon = R.drawable.vegetables,chance = GameChance.Life),
